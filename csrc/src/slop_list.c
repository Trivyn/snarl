        ...
        while (!(rdf_term_eq(current, nil_term))) {
            {
                ...
                if ((((int64_t)((first_matches.triples).len)) > 0)) {
                    __auto_type _mv_115 = ({ __auto_type _lst = first_matches.triples; size_t _idx = (size_t)0; slop_option_rdf_Triple _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_115.has_value) {
                        __auto_type first_triple = _mv_115.value;
            ...
            }
            {
                ...
                if ((((int64_t)((rest_matches.triples).len)) > 0)) {
                    __auto_type _mv_116 = ({ __auto_type _lst = rest_matches.triples; size_t _idx = (size_t)0; slop_option_rdf_Triple _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_116.has_value) {
                        __auto_type rest_triple = _mv_116.value;
        ...
        while (!(rdf_term_eq(current, nil_term))) {
            {
                ...
                if ((((int64_t)((first_matches).len)) > 0)) {
                    __auto_type _mv_117 = ({ __auto_type _lst = first_matches; size_t _idx = (size_t)0; slop_option_rdf_Triple _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            ...
            }
            {
                ...
                if ((((int64_t)((rest_matches).len)) > 0)) {
                    __auto_type _mv_118 = ({ __auto_type _lst = rest_matches; size_t _idx = (size_t)0; slop_option_rdf_Triple _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });

...
slop_result_xsd_XsdValue_xsd_XsdError xsd_parse_value(slop_arena* arena, slop_string lexical, xsd_XsdType dtype) {
    ...
    switch (_mv_47) {
        ...
        case xsd_XsdType_xsd_integer: {
            __auto_type _mv_48 = strlib_parse_int(lexical);
            if (_mv_48.is_ok) {
                __auto_type val = _mv_48.data.ok;
        ...
        case xsd_XsdType_xsd_decimal: {
            __auto_type _mv_49 = strlib_parse_float(lexical);
            if (_mv_49.is_ok) {
...
uint8_t xsd_validate_lexical(slop_string lexical, slop_string datatype_iri) {
    if (string_eq(datatype_iri, vocab_XSD_STRING)) {
        ...
        __auto_type _mv_52 = strlib_parse_int(lexical);
        if (_mv_52.is_ok) {
            __auto_type _ = _mv_52.data.ok;
            return 1;
        ...
        __auto_type _mv_56 = strlib_parse_int(lexical);
        if (_mv_56.is_ok) {
...
uint8_t xsd_values_equal(xsd_XsdValue a, xsd_XsdValue b) {
    ...
    switch (_mv_68.tag) {
        ...
        {
            __auto_type s1 = _mv_68.data.xsd_string_val;
            __auto_type _mv_69 = b;
            switch (_mv_69.tag) {
                case xsd_XsdValue_xsd_string_val:
                {
                    __auto_type s2 = _mv_69.data.xsd_string_val;
        ...
        {
            __auto_type i1 = _mv_68.data.xsd_integer_val;
            __auto_type _mv_70 = b;
            switch (_mv_70.tag) {
                case xsd_XsdValue_xsd_integer_val:
                {
                    __auto_type i2 = _mv_70.data.xsd_integer_val;
                    return (i1 == i2);
                }
                case xsd_XsdValue_xsd_decimal_val:
                {
                    __auto_type d2 = _mv_70.data.xsd_decimal_val;
                    return (((double)(i1)) == d2);
                }
                case xsd_XsdValue_xsd_float_val:
                {
                    __auto_type f2 = _mv_70.data.xsd_float_val;
                    return (((double)(i1)) == ((double)(f2)));
                }
                case xsd_XsdValue_xsd_double_val:
                {
                    __auto_type d2 = _mv_70.data.xsd_double_val;
                    return (((double)(i1)) == d2);
                }
                default: {
                    return 0;
        ...
        case xsd_XsdValue_xsd_decimal_val:
        {
            __auto_type d1 = _mv_68.data.xsd_decimal_val;
        ...
        case xsd_XsdValue_xsd_float_val:
        {
            __auto_type f1 = _mv_68.data.xsd_float_val;
        ...
        case xsd_XsdValue_xsd_double_val:
        {
            __auto_type d1 = _mv_68.data.xsd_double_val;
        ...
        {
            __auto_type b1 = _mv_68.data.xsd_boolean_val;
            __auto_type _mv_74 = b;
            switch (_mv_74.tag) {
                case xsd_XsdValue_xsd_boolean_val:
                {
                    __auto_type b2 = _mv_74.data.xsd_boolean_val;
                    return (b1 == b2);
                }
                default: {
                    return 0;
        ...
        {
            __auto_type u1 = _mv_68.data.xsd_unknown_val;
            __auto_type _mv_75 = b;
            switch (_mv_75.tag) {
                case xsd_XsdValue_xsd_unknown_val:
                {
                    __auto_type u2 = _mv_75.data.xsd_unknown_val;
...
slop_result_u8_xsd_XsdError xsd_literal_values_equal(slop_arena* arena, rdf_Literal a, rdf_Literal b) {
    __auto_type _mv_76 = a.lang;
    if (_mv_76.has_value) {
        __auto_type lang_a = _mv_76.value;
        __auto_type _mv_77 = b.lang;
        if (_mv_77.has_value) {
            __auto_type lang_b = _mv_77.value;
        ...
        __auto_type _mv_78 = a.datatype;
        if (_mv_78.has_value) {
            __auto_type dt_a = _mv_78.value;
            __auto_type _mv_79 = b.datatype;
            if (_mv_79.has_value) {
                __auto_type dt_b = _mv_79.value;
                {
...
xsd_XsdCompareResult xsd_values_compare(xsd_XsdValue a, xsd_XsdValue b) {
    ...
    switch (_mv_81.tag) {
        case xsd_XsdValue_xsd_integer_val:
        {
            __auto_type i1 = _mv_81.data.xsd_integer_val;
            {
        ...
        case xsd_XsdValue_xsd_decimal_val:
        {
            __auto_type d1 = _mv_81.data.xsd_decimal_val;
        ...
        case xsd_XsdValue_xsd_float_val:
        {
            __auto_type f1 = _mv_81.data.xsd_float_val;
            {
        ...
        case xsd_XsdValue_xsd_double_val:
        {
            __auto_type d1 = _mv_81.data.xsd_double_val;
        ...
        case xsd_XsdValue_xsd_string_val:
        {
            __auto_type s1 = _mv_81.data.xsd_string_val;
            __auto_type _mv_86 = b;
            switch (_mv_86.tag) {
                case xsd_XsdValue_xsd_string_val:
                {
                    __auto_type s2 = _mv_86.data.xsd_string_val;
                    if (string_eq(s1, s2)) {
                        return xsd_XsdCompareResult_xsd_compare_equal;
                    } else {
                        return xsd_XsdCompareResult_xsd_compare_incomparable;
        ...
        case xsd_XsdValue_xsd_boolean_val:
        {
            __auto_type b1 = _mv_81.data.xsd_boolean_val;
            __auto_type _mv_87 = b;
            switch (_mv_87.tag) {
                case xsd_XsdValue_xsd_boolean_val:
                {
                    __auto_type b2 = _mv_87.data.xsd_boolean_val;
                    if ((b1 == b2)) {
                        return xsd_XsdCompareResult_xsd_compare_equal;
                    } else {
                        if (b2) {
        ...
        case xsd_XsdValue_xsd_unknown_val:
        {
            __auto_type _ = _mv_81.data.xsd_unknown_val;
            return xsd_XsdCompareResult_xsd_compare_incomparable;
        }
    }
}
...
xsd_XsdCompareResult xsd_compare(slop_arena* arena, rdf_Term a, rdf_Term b) {
    ...
    switch (_mv_88.tag) {
        ...
        {
            __auto_type lit_a = _mv_88.data.term_literal;
            __auto_type _mv_89 = b;
            switch (_mv_89.tag) {
                case rdf_Term_term_literal:
                {
                    __auto_type lit_b = _mv_89.data.term_literal;
                    {
                        ...
                        __auto_type dt_b = ({ __auto_type _mv = lit_b.datatype; _mv.has_value ? ({ __auto_type d = _mv.value; d; }) : (vocab_XSD_STRING); });
                        {
                            ...
                            if (!(xsd_types_compatible(type_a, type_b))) {
                                ...
                                __auto_type _mv_90 = xsd_parse_value(arena, lit_a.value, type_a);
                                if (_mv_90.is_ok) {
                                    __auto_type val_a = _mv_90.data.ok;
                                    __auto_type _mv_91 = xsd_parse_value(arena, lit_b.value, type_b);
                                    if (_mv_91.is_ok) {
                                        __auto_type val_b = _mv_91.data.ok;

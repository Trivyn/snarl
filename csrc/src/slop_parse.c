...
types_ShapesGraph snarl_parse_shapes_graph(slop_arena* arena, index_IndexedGraph shapes_graph) {
    ...
    types_ShapesGraph _retval;
    {
        ...
        _retval = ((types_ShapesGraph){.node_shapes = node_shapes, .property_shapes = prop_shapes, .shape_map = shape_map});
    }
...
types_ShaclPath snarl_parse_path(slop_arena* arena, index_IndexedGraph g, rdf_Term path_node) {
    {
        ...
        if ((((int64_t)((inverse_objs).len)) > 0)) {
            __auto_type _mv_144 = ({ __auto_type _lst = inverse_objs; size_t _idx = (size_t)0; slop_option_rdf_Term _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            ...
            __auto_type _mv_145 = ({ __auto_type _lst = alt_objs; size_t _idx = (size_t)0; slop_option_rdf_Term _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_145.has_value) {
                __auto_type list_head = _mv_145.value;
                {
            ...
            __auto_type _mv_146 = ({ __auto_type _lst = zom_objs; size_t _idx = (size_t)0; slop_option_rdf_Term _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_146.has_value) {
                __auto_type inner = _mv_146.value;
                {
                    __auto_type p = snarl_parse_path(arena, g, inner);
                    __auto_type ptr = ((types_ShaclPath*)(({ __auto_type _alloc = (uint8_t*)slop_arena_alloc(arena, 128); if (_alloc == NULL) { fprintf(stderr, "SLOP: arena alloc failed at %s:%d\n", __FILE__, __LINE__); abort(); } _alloc; })));
                    (*ptr) = p;
            ...
            __auto_type _mv_147 = ({ __auto_type _lst = oom_objs; size_t _idx = (size_t)0; slop_option_rdf_Term _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
slop_list_types_Constraint snarl_parse_constraints(slop_arena* arena, index_IndexedGraph g, rdf_Term shape_id) {
    slop_list_types_Constraint _retval;
    {
        ...
        }
        {
            __auto_type nk_vals = rdf_indexed_graph_objects(arena, g, shape_id, rdf_make_iri(arena, vocab_SHACL_NODE_KIND));
            {
                ...
                for (size_t _i = 0; _i < _coll.len; _i++) {
                    __auto_type v = _coll.data[_i];
                    __auto_type _mv_148 = snarl_parse_node_kind(v);
                    if (_mv_148.has_value) {
                        __auto_type nk = _mv_148.value;
        ...
        }
        {
            __auto_type mc_vals = rdf_indexed_graph_objects(arena, g, shape_id, rdf_make_iri(arena, vocab_SHACL_MIN_COUNT));
            {
                ...
                for (size_t _i = 0; _i < _coll.len; _i++) {
                    __auto_type v = _coll.data[_i];
                    __auto_type _mv_149 = parse_term_to_int(v);
                    if (_mv_149.has_value) {
                        __auto_type n = _mv_149.value;
        ...
        }
        {
            __auto_type mc_vals = rdf_indexed_graph_objects(arena, g, shape_id, rdf_make_iri(arena, vocab_SHACL_MAX_COUNT));
            {
                ...
                for (size_t _i = 0; _i < _coll.len; _i++) {
                    __auto_type v = _coll.data[_i];
                    __auto_type _mv_150 = parse_term_to_int(v);
                    if (_mv_150.has_value) {
                        __auto_type n = _mv_150.value;
        ...
        }
        {
            __auto_type vals = rdf_indexed_graph_objects(arena, g, shape_id, rdf_make_iri(arena, vocab_SHACL_MIN_LENGTH));
            {
                ...
                for (size_t _i = 0; _i < _coll.len; _i++) {
                    __auto_type v = _coll.data[_i];
                    __auto_type _mv_151 = parse_term_to_int(v);
                    if (_mv_151.has_value) {
                        __auto_type n = _mv_151.value;
        ...
        }
        {
            __auto_type vals = rdf_indexed_graph_objects(arena, g, shape_id, rdf_make_iri(arena, vocab_SHACL_MAX_LENGTH));
            {
                ...
                for (size_t _i = 0; _i < _coll.len; _i++) {
                    __auto_type v = _coll.data[_i];
                    __auto_type _mv_152 = parse_term_to_int(v);
                    if (_mv_152.has_value) {
                        __auto_type n = _mv_152.value;
        ...
        }
        {
            __auto_type vals = rdf_indexed_graph_objects(arena, g, shape_id, rdf_make_iri(arena, vocab_SHACL_PATTERN));
            {
                ...
                for (size_t _i = 0; _i < _coll.len; _i++) {
                    __auto_type v = _coll.data[_i];
                    __auto_type _mv_153 = parse_term_to_string(v);
                    if (_mv_153.has_value) {
                        __auto_type s = _mv_153.value;
        ...
        }
        {
            __auto_type vals = rdf_indexed_graph_objects(arena, g, shape_id, rdf_make_iri(arena, vocab_SHACL_UNIQUE_LANG));
            {
                ...
                for (size_t _i = 0; _i < _coll.len; _i++) {
                    __auto_type v = _coll.data[_i];
                    __auto_type _mv_154 = parse_term_to_bool(v);
                    if (_mv_154.has_value) {
                        __auto_type b = _mv_154.value;
                        ({ __auto_type _lst_p = &(constraints); __auto_type _item = (((types_Constraint){ .tag = types_Constraint_con_unique_lang, .data.con_unique_lang = b })); if (_lst_p->len >= _lst_p->cap) { size_t _new_cap = _lst_p->cap == 0 ? 16 : _lst_p->cap * 2; __typeof__(_lst_p->data) _new_data = (__typeof__(_lst_p->data))slop_arena_alloc(arena, _new_cap * sizeof(*_lst_p->data)); if (_lst_p->len > 0) memcpy(_new_data, _lst_p->data, _lst_p->len * sizeof(*_lst_p->data)); _lst_p->data = _new_data; _lst_p->cap = _new_cap; } _lst_p->data[_lst_p->len++] = _item; (void)0; });
            ...
            __auto_type qvs_vals = rdf_indexed_graph_objects(arena, g, shape_id, rdf_make_iri(arena, vocab_SHACL_QUALIFIED_VALUE_SHAPE));
            {
                ...
                for (size_t _i = 0; _i < _coll.len; _i++) {
                    __auto_type v = _coll.data[_i];
                    {
                        ...
                        __auto_type qmin = (((((int64_t)((qmin_vals).len)) > 0)) ? ({ __auto_type _mv = ({ __auto_type _lst = qmin_vals; size_t _idx = (size_t)0; slop_option_rdf_Term _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; }); _mv.has_value ? ({ __auto_type t = _mv.value; ({ __auto_type _mv = parse_term_to_int(t); _mv.has_value ? ({ __auto_type n = _mv.value; n; }) : (0); }); }) : (0); }) : 0);
                        __auto_type qmax = (((((int64_t)((qmax_vals).len)) > 0)) ? ({ __auto_type _mv = ({ __auto_type _lst = qmax_vals; size_t _idx = (size_t)0; slop_option_rdf_Term _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; }); _mv.has_value ? ({ __auto_type t = _mv.value; ({ __auto_type _mv = parse_term_to_int(t); _mv.has_value ? ({ __auto_type n = _mv.value; (slop_option_int){.has_value = 1, .value = n}; }) : ((slop_option_int){.has_value = false}); }); }) : ((slop_option_int){.has_value = false}); }) : (slop_option_int){.has_value = false});
                        ({ __auto_type _lst_p = &(constraints); __auto_type _item = (((types_Constraint){ .tag = types_Constraint_con_qualified_value_shape, .data.con_qualified_value_shape = v })); if (_lst_p->len >= _lst_p->cap) { size_t _new_cap = _lst_p->cap == 0 ? 16 : _lst_p->cap * 2; __typeof__(_lst_p->data) _new_data = (__typeof__(_lst_p->data))slop_arena_alloc(arena, _new_cap * sizeof(*_lst_p->data)); if (_lst_p->len > 0) memcpy(_new_data, _lst_p->data, _lst_p->len * sizeof(*_lst_p->data)); _lst_p->data = _new_data; _lst_p->cap = _new_cap; } _lst_p->data[_lst_p->len++] = _item; (void)0; });
                    }
                }
            }
        }
        ...
        }
        {
            __auto_type closed_vals = rdf_indexed_graph_objects(arena, g, shape_id, rdf_make_iri(arena, vocab_SHACL_CLOSED));
            {
                ...
                for (size_t _i = 0; _i < _coll.len; _i++) {
                    __auto_type v = _coll.data[_i];
                    __auto_type _mv_155 = parse_term_to_bool(v);
                    if (_mv_155.has_value) {
                        __auto_type b = _mv_155.value;
                        if (b) {
                            {
                                ...
                                ({ __auto_type _lst_p = &(constraints); __auto_type _item = (((types_Constraint){ .tag = types_Constraint_con_closed, .data.con_closed = 1 })); if (_lst_p->len >= _lst_p->cap) { size_t _new_cap = _lst_p->cap == 0 ? 16 : _lst_p->cap * 2; __typeof__(_lst_p->data) _new_data = (__typeof__(_lst_p->data))slop_arena_alloc(arena, _new_cap * sizeof(*_lst_p->data)); if (_lst_p->len > 0) memcpy(_new_data, _lst_p->data, _lst_p->len * sizeof(*_lst_p->data)); _lst_p->data = _new_data; _lst_p->cap = _new_cap; } _lst_p->data[_lst_p->len++] = _item; (void)0; });
                            }
                        }
...
slop_option_types_NodeKind snarl_parse_node_kind(rdf_Term term) {
    __auto_type _mv_156 = term;
    switch (_mv_156.tag) {
        case rdf_Term_term_iri:
        {
            __auto_type iri = _mv_156.data.term_iri;
...
types_Severity snarl_parse_severity(rdf_Term term) {
    __auto_type _mv_157 = term;
    switch (_mv_157.tag) {
        case rdf_Term_term_iri:
        {
            __auto_type iri = _mv_157.data.term_iri;
...
types_Severity parse_parse_shape_severity(slop_arena* arena, index_IndexedGraph g, rdf_Term shape_id) {
    {
        ...
        if ((((int64_t)((sev_vals).len)) > 0)) {
            __auto_type _mv_158 = ({ __auto_type _lst = sev_vals; size_t _idx = (size_t)0; slop_option_rdf_Term _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_158.has_value) {
                __auto_type v = _mv_158.value;
...
slop_option_string parse_parse_shape_message(slop_arena* arena, index_IndexedGraph g, rdf_Term shape_id) {
    {
        ...
        if ((((int64_t)((msg_vals).len)) > 0)) {
            __auto_type _mv_159 = ({ __auto_type _lst = msg_vals; size_t _idx = (size_t)0; slop_option_rdf_Term _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_159.has_value) {
                __auto_type v = _mv_159.value;
...
uint8_t parse_parse_shape_deactivated(slop_arena* arena, index_IndexedGraph g, rdf_Term shape_id) {
    {
        ...
        if ((((int64_t)((vals).len)) > 0)) {
            __auto_type _mv_160 = ({ __auto_type _lst = vals; size_t _idx = (size_t)0; slop_option_rdf_Term _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_160.has_value) {
                __auto_type v = _mv_160.value;
                __auto_type _mv_161 = parse_term_to_bool(v);
                if (_mv_161.has_value) {
                    __auto_type b = _mv_161.value;
                    return b;
...
slop_option_int parse_term_to_int(rdf_Term t) {
    ...
    switch (_mv_162.tag) {
        ...
        {
            __auto_type lit = _mv_162.data.term_literal;
            __auto_type _mv_163 = strlib_parse_int(lit.value);
            if (_mv_163.is_ok) {
                __auto_type n = _mv_163.data.ok;
                if ((n >= 0)) {
...
slop_option_string parse_term_to_string(rdf_Term t) {
    __auto_type _mv_164 = t;
    switch (_mv_164.tag) {
        case rdf_Term_term_literal:
        {
            __auto_type lit = _mv_164.data.term_literal;
...
slop_option_u8 parse_term_to_bool(rdf_Term t) {
    __auto_type _mv_165 = t;
    switch (_mv_165.tag) {
        case rdf_Term_term_literal:
        {
            __auto_type lit = _mv_165.data.term_literal;
...
slop_list_string parse_parse_string_list(slop_arena* arena, index_IndexedGraph g, rdf_Term list_head) {
    {
        ...
        __auto_type result = ((slop_list_string){ .data = (slop_string*)slop_arena_alloc(arena, 16 * sizeof(slop_string)), .len = 0, .cap = 16 });
        {
            ...
            for (size_t _i = 0; _i < _coll.len; _i++) {
                __auto_type elem = _coll.data[_i];
                __auto_type _mv_166 = parse_term_to_string(elem);

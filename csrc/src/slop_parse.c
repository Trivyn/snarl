        ...
        }
        {
            ...
            while (changed) {
                ...
                while ((ns_i < ((int64_t)((ns_queue).len)))) {
                    __auto_type _mv_172 = ({ __auto_type _lst = ns_queue; size_t _idx = (size_t)ns_i; slop_option_rdf_Term _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_172.has_value) {
                        __auto_type ref = _mv_172.value;
                        __auto_type _mv_173 = ({ void* _ptr = slop_map_get(shape_map, &(ref)); _ptr ? (slop_option_types_NodeShape){ .has_value = true, .value = *(types_NodeShape*)_ptr } : (slop_option_types_NodeShape){ .has_value = false }; });
                        if (!_mv_173.has_value) {
                            changed = 1;
                            {
                                ...
                                ({ __auto_type _val = ns; void* _vptr = slop_arena_alloc(arena, sizeof(_val)); memcpy(_vptr, &_val, sizeof(_val)); slop_map_put(arena, shape_map, &(ref), _vptr); });
                                {
                                    ...
                                    for (size_t _i = 0; _i < _coll.len; _i++) {
                                        ...
                                        switch (_mv_174.tag) {
                                            case types_Constraint_con_not:
                                            {
                                                __auto_type r = _mv_174.data.con_not;
                                                ({ __auto_type _lst_p = &(ns_queue); __auto_type _item = (r); if (_lst_p->len >= _lst_p->cap) { size_t _new_cap = _lst_p->cap == 0 ? 16 : _lst_p->cap * 2; __typeof__(_lst_p->data) _new_data = (__typeof__(_lst_p->data))slop_arena_alloc(arena, _new_cap * sizeof(*_lst_p->data)); if (_lst_p->len > 0) memcpy(_new_data, _lst_p->data, _lst_p->len * sizeof(*_lst_p->data)); _lst_p->data = _new_data; _lst_p->cap = _new_cap; } _lst_p->data[_lst_p->len++] = _item; (void)0; });
                                                break;
                                            }
                                            case types_Constraint_con_and:
                                            {
                                                __auto_type rs = _mv_174.data.con_and;
                                                {
                                            ...
                                            case types_Constraint_con_or:
                                            {
                                                __auto_type rs = _mv_174.data.con_or;
                                                {
                                                    __auto_type _coll = rs;
                                                    for (size_t _i = 0; _i < _coll.len; _i++) {
                                                        __auto_type r = _coll.data[_i];
                                            ...
                                            case types_Constraint_con_xone:
                                            {
                                                __auto_type rs = _mv_174.data.con_xone;
                                                {
                                                    __auto_type _coll = rs;
                                                    for (size_t _i = 0; _i < _coll.len; _i++) {
                                                        __auto_type r = _coll.data[_i];
                                            ...
                                            case types_Constraint_con_node:
                                            {
                                                __auto_type r = _mv_174.data.con_node;
                                                ({ __auto_type _lst_p = &(ns_queue); __auto_type _item = (r); if (_lst_p->len >= _lst_p->cap) { size_t _new_cap = _lst_p->cap == 0 ? 16 : _lst_p->cap * 2; __typeof__(_lst_p->data) _new_data = (__typeof__(_lst_p->data))slop_arena_alloc(arena, _new_cap * sizeof(*_lst_p->data)); if (_lst_p->len > 0) memcpy(_new_data, _lst_p->data, _lst_p->len * sizeof(*_lst_p->data)); _lst_p->data = _new_data; _lst_p->cap = _new_cap; } _lst_p->data[_lst_p->len++] = _item; (void)0; });
                                                break;
                                            }
                                            case types_Constraint_con_qualified_value_shape:
                                            {
                                                __auto_type r = _mv_174.data.con_qualified_value_shape.f0;
                                                ({ __auto_type _lst_p = &(ns_queue); __auto_type _item = (r); if (_lst_p->len >= _lst_p->cap) { size_t _new_cap = _lst_p->cap == 0 ? 16 : _lst_p->cap * 2; __typeof__(_lst_p->data) _new_data = (__typeof__(_lst_p->data))slop_arena_alloc(arena, _new_cap * sizeof(*_lst_p->data)); if (_lst_p->len > 0) memcpy(_new_data, _lst_p->data, _lst_p->len * sizeof(*_lst_p->data)); _lst_p->data = _new_data; _lst_p->cap = _new_cap; } _lst_p->data[_lst_p->len++] = _item; (void)0; });
                                                break;
                                            }
                                            case types_Constraint_con_property:
                                            {
                                                __auto_type r = _mv_174.data.con_property;
                                ...
                                }
                                {
                                    ...
                                    for (size_t _i = 0; _i < _coll.len; _i++) {
                                        __auto_type ps = _coll.data[_i];
                                        __auto_type _mv_175 = ({ void* _ptr = slop_map_get(property_shape_map, &(ps.id)); _ptr ? (slop_option_types_PropertyShape){ .has_value = true, .value = *(types_PropertyShape*)_ptr } : (slop_option_types_PropertyShape){ .has_value = false }; });
                ...
                while ((ps_i < ((int64_t)((ps_queue).len)))) {
                    __auto_type _mv_177 = ({ __auto_type _lst = ps_queue; size_t _idx = (size_t)ps_i; slop_option_rdf_Term _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_177.has_value) {
                        __auto_type ref = _mv_177.value;
                        __auto_type _mv_178 = ({ void* _ptr = slop_map_get(property_shape_map, &(ref)); _ptr ? (slop_option_types_PropertyShape){ .has_value = true, .value = *(types_PropertyShape*)_ptr } : (slop_option_types_PropertyShape){ .has_value = false }; });
                                ...
                                ({ __auto_type _val = ps; void* _vptr = slop_arena_alloc(arena, sizeof(_val)); memcpy(_vptr, &_val, sizeof(_val)); slop_map_put(arena, property_shape_map, &(ref), _vptr); });
                                {
                                    ...
                                    for (size_t _i = 0; _i < _coll.len; _i++) {
                                        ...
                                        switch (_mv_179.tag) {
                                            case types_Constraint_con_not:
                                            {
                                                __auto_type r = _mv_179.data.con_not;
                                                ({ __auto_type _lst_p = &(ns_queue); __auto_type _item = (r); if (_lst_p->len >= _lst_p->cap) { size_t _new_cap = _lst_p->cap == 0 ? 16 : _lst_p->cap * 2; __typeof__(_lst_p->data) _new_data = (__typeof__(_lst_p->data))slop_arena_alloc(arena, _new_cap * sizeof(*_lst_p->data)); if (_lst_p->len > 0) memcpy(_new_data, _lst_p->data, _lst_p->len * sizeof(*_lst_p->data)); _lst_p->data = _new_data; _lst_p->cap = _new_cap; } _lst_p->data[_lst_p->len++] = _item; (void)0; });
                                                break;
                                            }
                                            case types_Constraint_con_and:
                                            {
                                                __auto_type rs = _mv_179.data.con_and;
                                                {
                                                    __auto_type _coll = rs;
                                                    for (size_t _i = 0; _i < _coll.len; _i++) {
                                                        __auto_type r = _coll.data[_i];
                                            ...
                                            case types_Constraint_con_or:
                                            {
                                                __auto_type rs = _mv_179.data.con_or;
                                                {
                                                    __auto_type _coll = rs;
                                                    for (size_t _i = 0; _i < _coll.len; _i++) {
                                                        __auto_type r = _coll.data[_i];
                                            ...
                                            case types_Constraint_con_xone:
                                            {
                                                __auto_type rs = _mv_179.data.con_xone;
                                                {
                                                    __auto_type _coll = rs;
                                                    for (size_t _i = 0; _i < _coll.len; _i++) {
                                                        __auto_type r = _coll.data[_i];
                                            ...
                                            case types_Constraint_con_node:
                                            {
                                                __auto_type r = _mv_179.data.con_node;
                                                ({ __auto_type _lst_p = &(ns_queue); __auto_type _item = (r); if (_lst_p->len >= _lst_p->cap) { size_t _new_cap = _lst_p->cap == 0 ? 16 : _lst_p->cap * 2; __typeof__(_lst_p->data) _new_data = (__typeof__(_lst_p->data))slop_arena_alloc(arena, _new_cap * sizeof(*_lst_p->data)); if (_lst_p->len > 0) memcpy(_new_data, _lst_p->data, _lst_p->len * sizeof(*_lst_p->data)); _lst_p->data = _new_data; _lst_p->cap = _new_cap; } _lst_p->data[_lst_p->len++] = _item; (void)0; });
                                                break;
                                            }
                                            case types_Constraint_con_qualified_value_shape:
                                            {
                                                __auto_type r = _mv_179.data.con_qualified_value_shape.f0;
                                                ({ __auto_type _lst_p = &(ns_queue); __auto_type _item = (r); if (_lst_p->len >= _lst_p->cap) { size_t _new_cap = _lst_p->cap == 0 ? 16 : _lst_p->cap * 2; __typeof__(_lst_p->data) _new_data = (__typeof__(_lst_p->data))slop_arena_alloc(arena, _new_cap * sizeof(*_lst_p->data)); if (_lst_p->len > 0) memcpy(_new_data, _lst_p->data, _lst_p->len * sizeof(*_lst_p->data)); _lst_p->data = _new_data; _lst_p->cap = _new_cap; } _lst_p->data[_lst_p->len++] = _item; (void)0; });
                                                break;
                                            }
                                            case types_Constraint_con_property:
                                            {
                                                __auto_type r = _mv_179.data.con_property;
                                                ({ __auto_type _lst_p = &(ps_queue); __auto_type _item = (r); if (_lst_p->len >= _lst_p->cap) { size_t _new_cap = _lst_p->cap == 0 ? 16 : _lst_p->cap * 2; __typeof__(_lst_p->data) _new_data = (__typeof__(_lst_p->data))slop_arena_alloc(arena, _new_cap * sizeof(*_lst_p->data)); if (_lst_p->len > 0) memcpy(_new_data, _lst_p->data, _lst_p->len * sizeof(*_lst_p->data)); _lst_p->data = _new_data; _lst_p->cap = _new_cap; } _lst_p->data[_lst_p->len++] = _item; (void)0; });
                                                break;
                                            }
                                            default: {
                        ...
                        __auto_type triples = rdf_indexed_graph_match(arena, shapes_graph, no_term, (slop_option_rdf_Term){.has_value = 1, .value = tp}, no_term);
                        {
                            ...
                            for (size_t _i = 0; _i < _coll.len; _i++) {
                                __auto_type tr = _coll.data[_i];
                                {
                                    ...
                                    __auto_type _mv_180 = ({ void* _ptr = slop_map_get(shape_map, &(subj)); _ptr ? (slop_option_types_NodeShape){ .has_value = true, .value = *(types_NodeShape*)_ptr } : (slop_option_types_NodeShape){ .has_value = false }; });
...
types_ShaclPath snarl_parse_path(slop_arena* arena, index_IndexedGraph g, rdf_Term path_node) {
    {
        ...
        if ((((int64_t)((first_objs).len)) > 0)) {
            ...
            __auto_type _mv_181 = ({ __auto_type _lst = inverse_objs; size_t _idx = (size_t)0; slop_option_rdf_Term _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            ...
            __auto_type _mv_182 = ({ __auto_type _lst = alt_objs; size_t _idx = (size_t)0; slop_option_rdf_Term _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_182.has_value) {
                __auto_type list_head = _mv_182.value;
                {
            ...
            __auto_type _mv_183 = ({ __auto_type _lst = zom_objs; size_t _idx = (size_t)0; slop_option_rdf_Term _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            ...
            __auto_type _mv_184 = ({ __auto_type _lst = oom_objs; size_t _idx = (size_t)0; slop_option_rdf_Term _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            ...
            __auto_type _mv_185 = ({ __auto_type _lst = zoo_objs; size_t _idx = (size_t)0; slop_option_rdf_Term _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
    ...
    slop_list_types_Constraint _retval = {0};
    {
        ...
        }
        {
            __auto_type nk_vals = rdf_indexed_graph_objects(arena, g, shape_id, rdf_make_iri(arena, vocab_SHACL_NODE_KIND));
            {
                ...
                for (size_t _i = 0; _i < _coll.len; _i++) {
                    __auto_type v = _coll.data[_i];
                    __auto_type _mv_186 = snarl_parse_node_kind(v);
                    if (_mv_186.has_value) {
                        __auto_type nk = _mv_186.value;
        ...
        }
        {
            __auto_type closed_vals = rdf_indexed_graph_objects(arena, g, shape_id, rdf_make_iri(arena, vocab_SHACL_CLOSED));
            {
                ...
                for (size_t _i = 0; _i < _coll.len; _i++) {
                    __auto_type v = _coll.data[_i];
                    __auto_type _mv_193 = parse_term_to_bool(v);
                    if (_mv_193.has_value) {
                        __auto_type b = _mv_193.value;
                        if (b) {
                            {
...
types_Severity parse_parse_shape_severity(slop_arena* arena, index_IndexedGraph g, rdf_Term shape_id) {
    {
        ...
        if ((((int64_t)((sev_vals).len)) > 0)) {
            __auto_type _mv_196 = ({ __auto_type _lst = sev_vals; size_t _idx = (size_t)0; slop_option_rdf_Term _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
slop_option_string parse_parse_shape_message(slop_arena* arena, index_IndexedGraph g, rdf_Term shape_id) {
    {
        ...
        if ((((int64_t)((msg_vals).len)) > 0)) {
            __auto_type _mv_197 = ({ __auto_type _lst = msg_vals; size_t _idx = (size_t)0; slop_option_rdf_Term _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
uint8_t parse_parse_shape_deactivated(slop_arena* arena, index_IndexedGraph g, rdf_Term shape_id) {
    {
        ...
        if ((((int64_t)((vals).len)) > 0)) {
            __auto_type _mv_198 = ({ __auto_type _lst = vals; size_t _idx = (size_t)0; slop_option_rdf_Term _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
slop_option_int parse_term_to_int(rdf_Term t) {
    __auto_type _mv_200 = t;
    switch (_mv_200.tag) {
        case rdf_Term_term_literal:
        {
            __auto_type lit = _mv_200.data.term_literal;
            __auto_type _mv_201 = strlib_parse_int(lit.value);
            if (_mv_201.is_ok) {
                __auto_type n = _mv_201.data.ok;
                if ((n >= 0)) {
                ...
                __auto_type _ = _mv_201.data.err;
                return (slop_option_int){.has_value = false};
            }
        }
        default: {
...
slop_list_string parse_parse_string_list(slop_arena* arena, index_IndexedGraph g, rdf_Term list_head) {
    {
        ...
        __auto_type result = ((slop_list_string){ .data = (slop_string*)slop_arena_alloc(arena, 16 * sizeof(slop_string)), .len = 0, .cap = 16 });
        {
            ...
            for (size_t _i = 0; _i < _coll.len; _i++) {
                __auto_type elem = _coll.data[_i];
                __auto_type _mv_204 = parse_term_to_string(elem);

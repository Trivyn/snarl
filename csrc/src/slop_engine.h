...
#ifndef SLOP_OPTION_ENGINE_CYCLEGUARD_DEFINED
#define SLOP_OPTION_ENGINE_CYCLEGUARD_DEFINED
SLOP_OPTION_DEFINE(engine_CycleGuard, slop_option_engine_CycleGuard)
#endif

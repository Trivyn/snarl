...
uint8_t value_type_datatype_matches(rdf_Term value_node, rdf_Term required_datatype) {
    __auto_type _mv_148 = value_node;
    switch (_mv_148.tag) {
        case rdf_Term_term_literal:
        {
            __auto_type lit = _mv_148.data.term_literal;
            {
                ...
                __auto_type _mv_149 = lit.datatype;
                if (_mv_149.has_value) {
                    __auto_type dt = _mv_149.value;

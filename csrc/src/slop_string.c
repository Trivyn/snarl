...
slop_string string_term_string_value(rdf_Term t) {
    ...
    __auto_type _mv_126 = t;
    switch (_mv_126.tag) {
        case rdf_Term_term_literal:
        {
            __auto_type lit = _mv_126.data.term_literal;
            return lit.value;
        }
        case rdf_Term_term_iri:
        {
            __auto_type iri = _mv_126.data.term_iri;
            return iri.value;
        }
        case rdf_Term_term_blank:
        {
            __auto_type _ = _mv_126.data.term_blank;
            return SLOP_STR("");
        }
        case rdf_Term_term_triple:
        {
            __auto_type _ = _mv_126.data.term_triple;
            return SLOP_STR("");
        }
    }
...
slop_string string_term_lang(rdf_Term t) {
    ...
    switch (_mv_127.tag) {
        case rdf_Term_term_literal:
        {
            __auto_type lit = _mv_127.data.term_literal;
            __auto_type _mv_128 = lit.lang;
            if (_mv_128.has_value) {
                __auto_type lang = _mv_128.value;
                return lang;
...
uint8_t string_term_is_literal(rdf_Term t) {
    ...
    switch (_mv_129.tag) {
        case rdf_Term_term_literal:
        {
            __auto_type _ = _mv_129.data.term_literal;
            return 1;
        }
        default: {
            return 0;
...
slop_option_types_ValidationResult snarl_check_language_in(slop_arena* arena, rdf_Term focus_node, rdf_Term value_node, slop_list_string allowed_langs, slop_option_types_ShaclPath path, rdf_Term shape_id, types_Severity severity, slop_option_string message) {
    ...
    slop_option_types_ValidationResult _retval = {0};
    __auto_type _mv_130 = value_node;
    switch (_mv_130.tag) {
        case rdf_Term_term_literal:
        {

                                                ...
                                                for (size_t _i = 0; _i < _coll.len; _i++) {
                                                    __auto_type r = _coll.data[_i];
                                                    {
                                                        ...
                                                        if (include) {
                                                            ...
                                                            __auto_type _mv_147 = r.severity;
                                                            switch (_mv_147) {
...
slop_list_types_ValidationResult snarl_evaluate_node_shape_cached(slop_arena* arena, index_IndexedGraph data_graph, types_ShapesGraph shapes_graph, target_ClassIndex class_index, types_NodeShape shape, rdf_Term focus_node, slop_map* visited, types_ValidatorConfig config) {
    {
        ...
        }
        {
            ...
            for (size_t _i = 0; _i < _coll.len; _i++) {
                __auto_type constraint = _coll.data[_i];
                __auto_type _mv_148 = constraint;
                if (_mv_148.tag == types_Constraint_con_closed && _mv_148.data.con_closed.f0 == 1) {
                    __auto_type ignored_paths = _mv_148.data.con_closed.f1;
                    {
                        ...
                        }
                        {
                            __auto_type i = 0;
                            while (i < ign_len) {
                                __auto_type _mv_149 = ({ __auto_type _lst = ignored_paths; size_t _idx = (size_t)i; slop_option_types_ShaclPath _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_149.has_value) {
                                    __auto_type ip = _mv_149.value;
                    ...
                    if (!(ps.deactivated)) {
                        {
                            ...
                            for (size_t _i = 0; _i < _coll.len; _i++) {
                                ...
                                __auto_type _mv_150 = c;
                                switch (_mv_150.tag) {
                                    case types_Constraint_con_qualified_value_shape:
                                    {
                                        __auto_type ref = _mv_150.data.con_qualified_value_shape.f0;
                                        __auto_type disjoint = _mv_150.data.con_qualified_value_shape.f3;
                                        if (disjoint) {
                    ...
                    if (!(ps.deactivated)) {
                        {
                            ...
                            while (i < n) {
                                __auto_type _mv_151 = ({ __auto_type _lst = all_disjoint_ps_ids; size_t _idx = (size_t)i; slop_option_rdf_Term _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_151.has_value) {
                                    __auto_type pid = _mv_151.value;
                                    if (!(rdf_term_eq(pid, ps_id))) {
                                        __auto_type _mv_152 = ({ __auto_type _lst = all_disjoint_qvs; size_t _idx = (size_t)i; slop_option_rdf_Term _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                        if (_mv_152.has_value) {
                                            __auto_type ref = _mv_152.value;
...
slop_list_types_ValidationResult snarl_evaluate_constraint_cached(slop_arena* arena, index_IndexedGraph data_graph, types_ShapesGraph shapes_graph, target_ClassIndex class_index, rdf_Term focus_node, rdf_Term value_node, types_Constraint constraint, slop_option_types_ShaclPath path, rdf_Term shape_id, types_Severity severity, slop_option_string message, slop_map* visited) {
    {
        __auto_type results = ((slop_list_types_ValidationResult){ .data = (types_ValidationResult*)slop_arena_alloc(arena, 16 * sizeof(types_ValidationResult)), .len = 0, .cap = 16 });
        __auto_type _mv_153 = constraint;
        switch (_mv_153.tag) {
            case types_Constraint_con_class:
            {
                __auto_type required_class = _mv_153.data.con_class;
                __auto_type _mv_154 = value_type_check_class_with_index(arena, data_graph, class_index, focus_node, value_node, required_class, path, shape_id, severity, message);
            ...
            {
                __auto_type required_dt = _mv_153.data.con_datatype;
                __auto_type _mv_155 = snarl_check_datatype(arena, focus_node, value_node, required_dt, path, shape_id, severity, message);
            ...
            {
                __auto_type required_kind = _mv_153.data.con_node_kind;
                __auto_type _mv_156 = snarl_check_node_kind(arena, focus_node, value_node, required_kind, path, shape_id, severity, message);
            ...
            {
                __auto_type _ = _mv_153.data.con_min_count;
                break;
            }
            case types_Constraint_con_max_count:
            {
                __auto_type _ = _mv_153.data.con_max_count;
                break;
            }
            case types_Constraint_con_min_inclusive:
            {
                __auto_type limit = _mv_153.data.con_min_inclusive;
                __auto_type _mv_157 = snarl_check_min_inclusive(arena, focus_node, value_node, limit, path, shape_id, severity, message);
            ...
            {
                __auto_type limit = _mv_153.data.con_max_inclusive;
                __auto_type _mv_158 = snarl_check_max_inclusive(arena, focus_node, value_node, limit, path, shape_id, severity, message);
            ...
            {
                __auto_type limit = _mv_153.data.con_min_exclusive;
                __auto_type _mv_159 = snarl_check_min_exclusive(arena, focus_node, value_node, limit, path, shape_id, severity, message);
            ...
            {
                __auto_type limit = _mv_153.data.con_max_exclusive;
                __auto_type _mv_160 = snarl_check_max_exclusive(arena, focus_node, value_node, limit, path, shape_id, severity, message);
            ...
            {
                __auto_type min_len = _mv_153.data.con_min_length;
                __auto_type _mv_161 = snarl_check_min_length(arena, focus_node, value_node, min_len, path, shape_id, severity, message);
            ...
            {
                __auto_type max_len = _mv_153.data.con_max_length;
                __auto_type _mv_162 = snarl_check_max_length(arena, focus_node, value_node, max_len, path, shape_id, severity, message);
            ...
            {
                __auto_type pat = _mv_153.data.con_pattern;
                __auto_type _mv_163 = snarl_check_pattern(arena, focus_node, value_node, pat, path, shape_id, severity, message);
            ...
            {
                __auto_type allowed_langs = _mv_153.data.con_language_in;
                __auto_type _mv_164 = snarl_check_language_in(arena, focus_node, value_node, allowed_langs, path, shape_id, severity, message);
            ...
            {
                __auto_type _ = _mv_153.data.con_unique_lang;
                break;
            }
            case types_Constraint_con_equals:
            {
                __auto_type other_path = _mv_153.data.con_equals;
                {
            ...
            {
                __auto_type other_path = _mv_153.data.con_disjoint;
                {
                    __auto_type single_list = ((slop_list_rdf_Term){ .data = (rdf_Term*)slop_arena_alloc(arena, 16 * sizeof(rdf_Term)), .len = 0, .cap = 16 });
                    ({ __auto_type _lst_p = &(single_list); __auto_type _item = (value_node); if (_lst_p->len >= _lst_p->cap) { size_t _new_cap = _lst_p->cap == 0 ? 16 : _lst_p->cap * 2; __typeof__(_lst_p->data) _new_data = (__typeof__(_lst_p->data))slop_arena_alloc(arena, _new_cap * sizeof(*_lst_p->data)); if (_lst_p->len > 0) memcpy(_new_data, _lst_p->data, _lst_p->len * sizeof(*_lst_p->data)); _lst_p->data = _new_data; _lst_p->cap = _new_cap; } _lst_p->data[_lst_p->len++] = _item; (void)0; });
                    {
            ...
            {
                __auto_type other_path = _mv_153.data.con_less_than;
                {
                    __auto_type single_list = ((slop_list_rdf_Term){ .data = (rdf_Term*)slop_arena_alloc(arena, 16 * sizeof(rdf_Term)), .len = 0, .cap = 16 });
                    ({ __auto_type _lst_p = &(single_list); __auto_type _item = (value_node); if (_lst_p->len >= _lst_p->cap) { size_t _new_cap = _lst_p->cap == 0 ? 16 : _lst_p->cap * 2; __typeof__(_lst_p->data) _new_data = (__typeof__(_lst_p->data))slop_arena_alloc(arena, _new_cap * sizeof(*_lst_p->data)); if (_lst_p->len > 0) memcpy(_new_data, _lst_p->data, _lst_p->len * sizeof(*_lst_p->data)); _lst_p->data = _new_data; _lst_p->cap = _new_cap; } _lst_p->data[_lst_p->len++] = _item; (void)0; });
                    {
            ...
            {
                __auto_type other_path = _mv_153.data.con_less_than_or_equals;
                {
                    __auto_type single_list = ((slop_list_rdf_Term){ .data = (rdf_Term*)slop_arena_alloc(arena, 16 * sizeof(rdf_Term)), .len = 0, .cap = 16 });
                    ({ __auto_type _lst_p = &(single_list); __auto_type _item = (value_node); if (_lst_p->len >= _lst_p->cap) { size_t _new_cap = _lst_p->cap == 0 ? 16 : _lst_p->cap * 2; __typeof__(_lst_p->data) _new_data = (__typeof__(_lst_p->data))slop_arena_alloc(arena, _new_cap * sizeof(*_lst_p->data)); if (_lst_p->len > 0) memcpy(_new_data, _lst_p->data, _lst_p->len * sizeof(*_lst_p->data)); _lst_p->data = _new_data; _lst_p->cap = _new_cap; } _lst_p->data[_lst_p->len++] = _item; (void)0; });
                    {
            ...
            {
                __auto_type required_value = _mv_153.data.con_has_value;
                {
                    __auto_type single_list = ((slop_list_rdf_Term){ .data = (rdf_Term*)slop_arena_alloc(arena, 16 * sizeof(rdf_Term)), .len = 0, .cap = 16 });
                    ({ __auto_type _lst_p = &(single_list); __auto_type _item = (value_node); if (_lst_p->len >= _lst_p->cap) { size_t _new_cap = _lst_p->cap == 0 ? 16 : _lst_p->cap * 2; __typeof__(_lst_p->data) _new_data = (__typeof__(_lst_p->data))slop_arena_alloc(arena, _new_cap * sizeof(*_lst_p->data)); if (_lst_p->len > 0) memcpy(_new_data, _lst_p->data, _lst_p->len * sizeof(*_lst_p->data)); _lst_p->data = _new_data; _lst_p->cap = _new_cap; } _lst_p->data[_lst_p->len++] = _item; (void)0; });
                    __auto_type _mv_165 = snarl_check_has_value(arena, focus_node, single_list, required_value, path, shape_id, severity, message);
            ...
            {
                __auto_type allowed_values = _mv_153.data.con_in;
                __auto_type _mv_166 = snarl_check_in(arena, focus_node, value_node, allowed_values, path, shape_id, severity, message);
            ...
            {
                __auto_type shape_ref = _mv_153.data.con_not;
                {
                    ...
                    __auto_type _mv_167 = snarl_check_not(arena, focus_node, conforms, path, shape_id, severity, message);
                    if (_mv_167.has_value) {
                        __auto_type r = _mv_167.value;
                        ({ __auto_type _lst_p = &(results); __auto_type _item = (r); if (_lst_p->len >= _lst_p->cap) { size_t _new_cap = _lst_p->cap == 0 ? 16 : _lst_p->cap * 2; __typeof__(_lst_p->data) _new_data = (__typeof__(_lst_p->data))slop_arena_alloc(arena, _new_cap * sizeof(*_lst_p->data)); if (_lst_p->len > 0) memcpy(_new_data, _lst_p->data, _lst_p->len * sizeof(*_lst_p->data)); _lst_p->data = _new_data; _lst_p->cap = _new_cap; } _lst_p->data[_lst_p->len++] = _item; (void)0; });
            ...
            {
                __auto_type shape_refs = _mv_153.data.con_and;
                {
                    __auto_type all_pass = 1;
                    {
                        ...
                        for (size_t _i = 0; _i < _coll.len; _i++) {
                            ...
                            __auto_type _mv_168 = ({ void* _ptr = slop_map_get(shapes_graph.property_shape_map, &(ref)); _ptr ? (slop_option_types_PropertyShape){ .has_value = true, .value = *(types_PropertyShape*)_ptr } : (slop_option_types_PropertyShape){ .has_value = false }; });
                            if (_mv_168.has_value) {
                            ...
                            } else if (!_mv_168.has_value) {
                                {
                                    ...
                                    __auto_type _mv_169 = ({ void* _ptr = slop_map_get(shapes_graph.shape_map, &(ref)); _ptr ? (slop_option_types_NodeShape){ .has_value = true, .value = *(types_NodeShape*)_ptr } : (slop_option_types_NodeShape){ .has_value = false }; });
                                    if (_mv_169.has_value) {
                                        __auto_type ref_shape = _mv_169.value;
                    ...
                    __auto_type _mv_170 = snarl_check_and(arena, focus_node, all_pass, path, shape_id, severity, message);
            ...
            {
                __auto_type shape_refs = _mv_153.data.con_or;
                {
                    __auto_type any_pass = 0;
                    {
                        ...
                        for (size_t _i = 0; _i < _coll.len; _i++) {
                            __auto_type ref = _coll.data[_i];
                            __auto_type _mv_171 = ({ void* _ptr = slop_map_get(shapes_graph.property_shape_map, &(ref)); _ptr ? (slop_option_types_PropertyShape){ .has_value = true, .value = *(types_PropertyShape*)_ptr } : (slop_option_types_PropertyShape){ .has_value = false }; });
                            if (_mv_171.has_value) {
                                __auto_type ref_ps = _mv_171.value;
                                if (snarl_property_shape_conforms_cached(arena, data_graph, shapes_graph, class_index, value_node, ref_ps)) {
                                    any_pass = 1;
                                }
                            } else if (!_mv_171.has_value) {
                                {
                                    __auto_type rec_visited = slop_map_new_ptr(arena, 16, sizeof(rdf_Term), slop_hash_rdf_Term, slop_eq_rdf_Term);
                                    ({ uint8_t _dummy = 1; slop_map_put(arena, rec_visited, &(ref), &_dummy); });
                                    __auto_type _mv_172 = ({ void* _ptr = slop_map_get(shapes_graph.shape_map, &(ref)); _ptr ? (slop_option_types_NodeShape){ .has_value = true, .value = *(types_NodeShape*)_ptr } : (slop_option_types_NodeShape){ .has_value = false }; });
                                    if (_mv_172.has_value) {
                                        __auto_type ref_shape = _mv_172.value;
                                        if (snarl_evaluate_shape_against_node_cached(arena, data_graph, shapes_graph, class_index, value_node, ref_shape, rec_visited)) {
                                            any_pass = 1;
                                        }
                    ...
                    __auto_type _mv_173 = snarl_check_or(arena, focus_node, any_pass, path, shape_id, severity, message);
            ...
            {
                __auto_type shape_refs = _mv_153.data.con_xone;
                {
                    __auto_type pass_count = 0;
                    {
                        ...
                        for (size_t _i = 0; _i < _coll.len; _i++) {
                            __auto_type ref = _coll.data[_i];
                            __auto_type _mv_174 = ({ void* _ptr = slop_map_get(shapes_graph.property_shape_map, &(ref)); _ptr ? (slop_option_types_PropertyShape){ .has_value = true, .value = *(types_PropertyShape*)_ptr } : (slop_option_types_PropertyShape){ .has_value = false }; });
                            if (_mv_174.has_value) {
                                __auto_type ref_ps = _mv_174.value;
                                if (snarl_property_shape_conforms_cached(arena, data_graph, shapes_graph, class_index, value_node, ref_ps)) {
                            ...
                            } else if (!_mv_174.has_value) {
                                {
                                    __auto_type rec_visited = slop_map_new_ptr(arena, 16, sizeof(rdf_Term), slop_hash_rdf_Term, slop_eq_rdf_Term);
                                    ({ uint8_t _dummy = 1; slop_map_put(arena, rec_visited, &(ref), &_dummy); });
                                    __auto_type _mv_175 = ({ void* _ptr = slop_map_get(shapes_graph.shape_map, &(ref)); _ptr ? (slop_option_types_NodeShape){ .has_value = true, .value = *(types_NodeShape*)_ptr } : (slop_option_types_NodeShape){ .has_value = false }; });
                                    if (_mv_175.has_value) {
                                        __auto_type ref_shape = _mv_175.value;
                                        if (snarl_evaluate_shape_against_node_cached(arena, data_graph, shapes_graph, class_index, value_node, ref_shape, rec_visited)) {
                                            pass_count = (pass_count + 1);
                                        }
                    ...
                    __auto_type _mv_176 = snarl_check_xone(arena, focus_node, pass_count, path, shape_id, severity, message);
            ...
            {
                __auto_type shape_ref = _mv_153.data.con_node;
                {
                    ...
                    __auto_type _mv_177 = snarl_check_node(arena, focus_node, value_node, value_conforms, path, shape_id, severity, message);
            ...
            {
                __auto_type _ = _mv_153.data.con_property;
                break;
            }
            case types_Constraint_con_qualified_value_shape:
            {
...
slop_list_types_ValidationResult snarl_evaluate_constraint_for_property_cached(slop_arena* arena, index_IndexedGraph data_graph, types_ShapesGraph shapes_graph, target_ClassIndex class_index, rdf_Term focus_node, slop_list_rdf_Term value_nodes, int64_t value_count, types_Constraint constraint, slop_option_types_ShaclPath path, rdf_Term shape_id, types_Severity severity, slop_option_string message, slop_map* visited, slop_list_rdf_Term sibling_qvs_refs) {
    {
        __auto_type results = ((slop_list_types_ValidationResult){ .data = (types_ValidationResult*)slop_arena_alloc(arena, 16 * sizeof(types_ValidationResult)), .len = 0, .cap = 16 });
        __auto_type _mv_178 = constraint;
        switch (_mv_178.tag) {
            case types_Constraint_con_min_count:
            {
                __auto_type min_c = _mv_178.data.con_min_count;
                __auto_type _mv_179 = snarl_check_min_count(arena, focus_node, value_count, min_c, path, shape_id, severity, message);
            ...
            case types_Constraint_con_max_count:
            {
                __auto_type max_c = _mv_178.data.con_max_count;
                __auto_type _mv_180 = snarl_check_max_count(arena, focus_node, value_count, max_c, path, shape_id, severity, message);
            ...
            case types_Constraint_con_unique_lang:
            {
                __auto_type b = _mv_178.data.con_unique_lang;
                if (b) {
                    {
            ...
            case types_Constraint_con_has_value:
            {
                __auto_type required_value = _mv_178.data.con_has_value;
                __auto_type _mv_181 = snarl_check_has_value(arena, focus_node, value_nodes, required_value, path, shape_id, severity, message);
            ...
            case types_Constraint_con_equals:
            {
                __auto_type other_path = _mv_178.data.con_equals;
                {
            ...
            case types_Constraint_con_disjoint:
            {
                __auto_type other_path = _mv_178.data.con_disjoint;
                {
            ...
            case types_Constraint_con_less_than:
            {
                __auto_type other_path = _mv_178.data.con_less_than;
                {
            ...
            case types_Constraint_con_less_than_or_equals:
            {
                __auto_type other_path = _mv_178.data.con_less_than_or_equals;
                {
            ...
            case types_Constraint_con_qualified_value_shape:
            {
                __auto_type shape_ref = _mv_178.data.con_qualified_value_shape.f0;
                __auto_type q_min = _mv_178.data.con_qualified_value_shape.f1;
                __auto_type q_max = _mv_178.data.con_qualified_value_shape.f2;
                __auto_type disjoint = _mv_178.data.con_qualified_value_shape.f3;
                {
                    __auto_type conforming_count = 0;
                    {
                        ...
                        for (size_t _i = 0; _i < _coll.len; _i++) {
                            __auto_type vn = _coll.data[_i];
                            {
                                ...
                                __auto_type _mv_182 = ({ void* _ptr = slop_map_get(shapes_graph.shape_map, &(shape_ref)); _ptr ? (slop_option_types_NodeShape){ .has_value = true, .value = *(types_NodeShape*)_ptr } : (slop_option_types_NodeShape){ .has_value = false }; });
                                if (_mv_182.has_value) {
                                    __auto_type ref_shape = _mv_182.value;
                                                ...
                                                __auto_type conforms_to_sibling = 0;
                                                {
                                                    ...
                                                    for (size_t _i = 0; _i < _coll.len; _i++) {
                                                        __auto_type sib_ref = _coll.data[_i];
                                                        {
                                                            ...
                                                            __auto_type _mv_183 = ({ void* _ptr = slop_map_get(shapes_graph.shape_map, &(sib_ref)); _ptr ? (slop_option_types_NodeShape){ .has_value = true, .value = *(types_NodeShape*)_ptr } : (slop_option_types_NodeShape){ .has_value = false }; });
                                                            if (_mv_183.has_value) {
                                                                __auto_type sib_shape = _mv_183.value;
            ...
            case types_Constraint_con_property:
            {
                __auto_type ps_ref = _mv_178.data.con_property;
                __auto_type _mv_184 = ({ void* _ptr = slop_map_get(shapes_graph.property_shape_map, &(ps_ref)); _ptr ? (slop_option_types_PropertyShape){ .has_value = true, .value = *(types_PropertyShape*)_ptr } : (slop_option_types_PropertyShape){ .has_value = false }; });
                if (_mv_184.has_value) {
                    __auto_type ref_ps = _mv_184.value;
                    {
                        __auto_type _coll = value_nodes;
                        for (size_t _i = 0; _i < _coll.len; _i++) {
                            __auto_type vn = _coll.data[_i];

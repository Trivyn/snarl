...
slop_list_rdf_Term data_graph_term_set_to_list(slop_arena* arena, index_TermSet terms);
...
data_graph_SnarlDataGraph snarl_data_graph_add(slop_arena* arena, data_graph_SnarlDataGraph g, rdf_Triple t) {
    if (snarl_data_graph_contains(g, t)) {
        return g;
    }
    {
        __auto_type s = rdf_triple_subject(t);
        ...
        data_graph_add_to_nested_set(arena, g.index.sp, s, p, o);
...
slop_list_rdf_Term snarl_data_graph_objects(slop_arena* arena, data_graph_SnarlDataGraph g, rdf_Term subj, rdf_Term pred) {
    ...
    if (_mv_60.has_value) {
        ...
        if (_mv_61.has_value) {
            ...
            return data_graph_term_set_to_list(arena, objs);
...
slop_list_rdf_Term snarl_data_graph_subjects(slop_arena* arena, data_graph_SnarlDataGraph g, rdf_Term pred, rdf_Term obj) {
    __auto_type _mv_62 = ({ void* _ptr = slop_map_get(g.index.po, &(pred)); _ptr ? (slop_option_ptr){ .has_value = true, .value = *(void**)_ptr } : (slop_option_ptr){ .has_value = false }; });
    if (_mv_62.has_value) {
        __auto_type obj_map = _mv_62.value;
        __auto_type _mv_63 = ({ void* _ptr = slop_map_get(obj_map, &(obj)); _ptr ? (slop_option_ptr){ .has_value = true, .value = *(void**)_ptr } : (slop_option_ptr){ .has_value = false }; });
        if (_mv_63.has_value) {
            __auto_type subjects = _mv_63.value;
            return data_graph_term_set_to_list(arena, subjects);
...
slop_list_rdf_Term snarl_data_graph_subjects_of(slop_arena* arena, data_graph_SnarlDataGraph g, rdf_Term pred) {
    __auto_type _mv_64 = ({ void* _ptr = slop_map_get(g.index.p_subjects, &(pred)); _ptr ? (slop_option_ptr){ .has_value = true, .value = *(void**)_ptr } : (slop_option_ptr){ .has_value = false }; });
    if (_mv_64.has_value) {
        __auto_type subjects = _mv_64.value;
        return data_graph_term_set_to_list(arena, subjects);
...
slop_list_rdf_Term snarl_data_graph_objects_of(slop_arena* arena, data_graph_SnarlDataGraph g, rdf_Term pred) {
    __auto_type _mv_65 = ({ void* _ptr = slop_map_get(g.index.p_objects, &(pred)); _ptr ? (slop_option_ptr){ .has_value = true, .value = *(void**)_ptr } : (slop_option_ptr){ .has_value = false }; });
    if (_mv_65.has_value) {
        __auto_type objects = _mv_65.value;
        return data_graph_term_set_to_list(arena, objects);
...
slop_list_rdf_Triple snarl_data_graph_triples_for_subject(slop_arena* arena, data_graph_SnarlDataGraph g, rdf_Term subj) {
    {
        ...
        __auto_type _mv_66 = ({ void* _ptr = slop_map_get(g.index.sp, &(subj)); _ptr ? (slop_option_ptr){ .has_value = true, .value = *(void**)_ptr } : (slop_option_ptr){ .has_value = false }; });
        if (_mv_66.has_value) {
            __auto_type pred_map = _mv_66.value;
            {
